...
{
	[ViewComponent(Name = "DashboardLast5Blogs")]
	public class DashboardLast5BlogsViewComponent(IHttpClientFactory httpClientFactory) : ViewComponent
	{
		public async Task<IViewComponentResult> InvokeAsync()
		{
			var client = httpClientFactory.CreateClient("CarRentalApi");
			var responseMessage = await client.GetAsync("Statistics/GetLast5BlogsWithAuthor");
