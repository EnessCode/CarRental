...
namespace CarRental.WebApi.Controllers 
{
		...
		) : ControllerBase
	{
		...
		public async Task<IActionResult> BannerList()
		{
			...
			return Ok(ApiResponse<List<GetBannerQueryResult>>.SuccessResponse(values, "Afiş listesi getirildi"));
		}
		...
		public async Task<IActionResult> BannerById(int id)
		{
			...
			return Ok(ApiResponse<GetBannerByIdQueryResult>.SuccessResponse(value, "Afiş kaydı getirildi"));
		}
		...
		public async Task<IActionResult> CreateBanner(CreateBannerCommand command)
		{
			...
			return StatusCode(201, ApiResponse<CreateBannerCommand>.SuccessResponse(createdData, "Afiş başarıyla eklendi"));
		}
		...
		public async Task<IActionResult> RemoveBanner(int id)
		{
			...
			return Ok(ApiResponse<RemoveBannerCommand>.SuccessResponse(removedData, "Kayıt silindi"));
		}
		...
		public async Task<IActionResult> UpdateBanner(UpdateBannerCommand command)
		{
			...
			return Ok(ApiResponse<UpdateBannerCommand>.SuccessResponse(updatedData, "Afiş başarıyla güncellendi"));
		}
	}
}